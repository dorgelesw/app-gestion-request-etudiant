...
public class UserControllerTest {
  ...
  public void when_find_staff_by_matricule_it_return_staff() throws Exception {
    ...
    staffDto.setPoste("staff-chef-dep-test-3");
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/iuc/users/staff?matricule=2CIUC2020")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.matricule", Matchers.is(staffDto.getMatricule())))
        .andExpect(MockMvcResultMatchers.jsonPath("$.email", Matchers.is(staffDto.getEmail())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.poste", Matchers.is(staffDto.getPoste())))
  ...
  public void when_find_staff_by_email_it_return_staff() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/iuc/users/staff?email=staff-test-3@iuc.com")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.nom", Matchers.is(staffDto.getNom())))
        .andExpect(MockMvcResultMatchers.jsonPath("$.prenom", Matchers.is(staffDto.getPrenom())))
  ...
  public void when_delete_staff_by_email_you_cannot_get_it_if_you_find_it() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete("/iuc/users/staff?email=staff-test-3@iuc.com")
  ...
  public void when_delete_staff_by_matricule_you_cannot_get_it_if_you_find_it() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete("/iuc/users/staff?matricule=2CIUC2020")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk());
  ...
  public void when_delete_student_by_matricule_you_cannot_get_it_if_you_find_it() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete("/iuc/users/student?matricule=1EIUC2021")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk());

    Mockito.verify(userService, Mockito.times(1))
        .deleteStudentByMatricule(studentDto.getMatricule());
  }
  ...
  public void when_delete_student_by_email_you_cannot_get_it_if_you_find_it() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete("/iuc/users/student?email=student-test-3@iuc.com")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk());
  ...
  public void when_find_student_by_email_it_return_student() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/iuc/users/student?email=student-test-3@iuc.com")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.matricule", Matchers.is(studentDto.getMatricule())))
  ...
  public void when_find_student_by_matricule_it_return_student() throws Exception {
    ...
    // ACT
    Mockito.when(userService.findStudentByMatricule(studentDto.getMatricule()))
        .thenReturn(studentDto);

    // ASSERT
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/iuc/users/student?matricule=1EIUC2021")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.nom", Matchers.is(studentDto.getNom())))
        .andExpect(MockMvcResultMatchers.jsonPath("$.prenom", Matchers.is(studentDto.getPrenom())))
  ...
  public void when_you_find_all_staff_it_should_return_all_staff() throws Exception {
    ...
    staffDto1.setPoste("staff-chef-dep-test-4");
    ...
    // ASSERT
    mockMvc
        .perform(MockMvcRequestBuilders.get("/iuc/users/staffs").accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].matricule", Matchers.is(staffDto.getMatricule())))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].email", Matchers.is(staffDto.getEmail())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].poste", Matchers.is(staffDto.getPoste())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].filiere", Matchers.is(staffDto.getFiliere())))
        .andExpect(MockMvcResultMatchers.jsonPath("$[1].nom", Matchers.is(staffDto1.getNom())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].prenom", Matchers.is(staffDto1.getPrenom())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].matricule", Matchers.is(staffDto1.getMatricule())))
        .andExpect(MockMvcResultMatchers.jsonPath("$[1].email", Matchers.is(staffDto1.getEmail())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].poste", Matchers.is(staffDto1.getPoste())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].filiere", Matchers.is(staffDto1.getFiliere())));
  ...
  public void when_you_find_all_student_by_filiere_it_should_return_all_student() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/iuc/users/students?filiere=MATHEMATIQUE")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].nom", Matchers.is(studentDto.getNom())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].prenom", Matchers.is(studentDto.getPrenom())))
        .andExpect(
            MockMvcResultMatchers.jsonPath(
                "$[0].matricule", Matchers.is(studentDto.getMatricule())))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].email", Matchers.is(studentDto.getEmail())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].niveau", Matchers.is(studentDto.getNiveau())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].filiere", Matchers.is(studentDto.getFiliere())))
        .andExpect(MockMvcResultMatchers.jsonPath("$[1].nom", Matchers.is(studentDto1.getNom())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].prenom", Matchers.is(studentDto1.getPrenom())))
        .andExpect(
            MockMvcResultMatchers.jsonPath(
                "$[1].matricule", Matchers.is(studentDto1.getMatricule())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].email", Matchers.is(studentDto1.getEmail())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].niveau", Matchers.is(studentDto1.getNiveau())))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].filiere", Matchers.is(studentDto1.getFiliere())));
  ...
  public void when_save_staff_it_should_return_staff() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/iuc/users/staff")
                .contentType(MediaType.APPLICATION_JSON)
  ...
  public void when_update_staff_it_should_return_staff() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.put("/iuc/users/staff")
                .contentType(MediaType.APPLICATION_JSON)
                .content(jsonStaffDto))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.nom", Matchers.is(staffDto.getNom())))
  ...
  public void when_update_student_it_should_return_a_same_student_with_new_modified_values()
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.put("/iuc/users/student")
                .contentType(MediaType.APPLICATION_JSON)
                .content(jsonStudentDto))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(MockMvcResultMatchers.jsonPath("$.nom", Matchers.is(studentDto.getNom())))
